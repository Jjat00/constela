...
insert into public.tags (category, label, aliases, is_curated) values
  ...
  ('rol', 'ai engineer',          array['ai','ia','inteligencia-artificial','agentes','agentico'], true),
  ...
  ('rol', 'devrel',               array['developer-relations'],                     true),
  ('rol', 'marketing',            array['growth','growth-hacker','digital-marketing','publicidad'], true),
  ('rol', 'comunicación',         array['comms','pr','prensa','relaciones-publicas'], true),
  ('rol', 'comunidad',            array['community-manager','community'],           true),
  ...
  ('rol', 'recruiter',            array['reclutador','talento'],                    true),
  ('rol', 'people',               array['hr','rrhh','talento-humano','cultura'],    true),
  ('rol', 'operaciones',          array['ops','operations','finanzas','administracion'], true),
  ('rol', 'project manager',      array['gestor-de-proyectos','scrum-master','agile-coach'], true),
  ('rol', 'legal',                array['abogado','compliance'],                    true),
  ...
  -- Intereses: de qué quieres hablar. Áreas GENERALES a propósito: en un
  -- evento se filtra por "backend" o "diseño", no por un framework. Lo
  -- específico ("go", "postgres", "react") vive como alias: escribirlo
  -- resuelve al área en vez de crear un gemelo hiperespecífico.
  ('interes', 'ia',               array['inteligencia-artificial','ai','llms','agentes','rag','mlops','machine-learning','computer-vision','prompts'], true),
  ('interes', 'frontend',         array['web','react','nextjs','vue','angular','javascript','typescript','css'], true),
  ('interes', 'backend',          array['apis','go','golang','java','node','python','rust','php','ruby','elixir'], true),
  ('interes', 'móvil',            array['mobile','android','ios','flutter','swift','kotlin','react-native'], true),
  ('interes', 'datos',            array['data','postgres','sql','analitica','bi','data-science','etl'], true),
  ('interes', 'infraestructura',  array['devops','cloud','kubernetes','docker','aws','gcp','azure','sre','plataforma'], true),
  ('interes', 'seguridad',        array['ciberseguridad','infosec','hacking','privacidad','appsec'], true),
  ('interes', 'diseño',           array['design','ux','ui','design-systems','figma','accesibilidad','diseno-grafico'], true),
  ('interes', 'producto',         array['product','product-management','discovery','no-code','saas'], true),
  ('interes', 'open source',      array['oss','codigo-abierto'],                    true),
  ('interes', 'gaming',           array['videojuegos','games','game-dev'],          true),
  ('interes', 'hardware',         array['iot','maker','electronica','robotica','ar-vr','drones'], true),
  ('interes', 'web3',             array['blockchain','cripto','crypto'],            true),
  ('interes', 'startups',         array['startup','emprendimiento','b2b'],          true),
  ('interes', 'inversión',        array['fundraising','levantar-capital','vc'],     true),
  ('interes', 'marketing',        array['growth','contenido','redes-sociales','branding','publicidad'], true),
  ('interes', 'comunidad',        array['community','meetups','devrel'],            true),
  ('interes', 'educación',        array['edtech','docencia','aprendizaje','mentoria'], true),
  ('interes', 'carrera',          array['career','crecimiento-profesional','trabajo-remoto','freelance'], true),
  ('interes', 'fintech',          array['pagos','banca'],                           true),
  ('interes', 'salud',            array['healthtech','biotech','bienestar'],        true),
  ('interes', 'ecommerce',        array['retail','comercio'],                       true),
  ('interes', 'sostenibilidad',   array['climatech','green','impacto-social'],      true),
