...
/* El verso del dominio cierra el hero: la frase corrida, centrada en el
   carril. Mono en caja baja, no versalitas: pasa de seis palabras
   (DESIGN §3). */
.obs-verso{grid-column:1/-1;margin:clamp(1.5rem,4vw,2.5rem) 0 0;font-family:var(--font-mono);font-size:11.5px;line-height:1.8;color:var(--faint);text-align:center}
